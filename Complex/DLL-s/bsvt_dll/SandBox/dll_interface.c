...
__declspec(dllexport)void LLD (PortsHdl input, 
	PortsHdl output, 
	ArrayOfMessagesHdl input_msg, 
	ArrayOfMessagesHdl output_msg, 
	ArrayOfStatesHdl array_of_states, 
	ArrayOfMessagesHdl voc_msg);
